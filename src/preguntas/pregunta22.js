...
<img src={cherimagenes(`./logoucc.png`)} class="relative left-4" />
    ...
    <h1 class=" w-1/3 relative ml-10 bottom-10 left-1/3 text-center font-Ubuntu text-white text-2xl ">22 ¿Cual es la ciudad mas cercana a la planta nuclear que esta   habitada actualmente?</h1>
    ...
    <img src={cherimagenes(`./cher-20.jpg`)} class="relative ml-96 left-52" />
       ...
       <Link to="/Video22" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Kiev</Link>
       <Link to="/Video22" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Moscu</Link>
       <Link to="/Video22" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Pripia</Link>
       <Link to="/Pregunta23" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Chernobil</Link>
       </ul>

...
const Video3 = ()=>{
    ...
    <ReactPlayer   url='https://www.youtube.com/watch?v=RXDNGB--FXU&ab_channel=jhonatan_611'
    controls
     
    />
    </div>
    <div class="relative top-44 left-1/3">
    <Link to="/Pregunta4" class=" w-2 h-10 my-40 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Siguiente Pregunta</Link>
    </div>
</div>
}

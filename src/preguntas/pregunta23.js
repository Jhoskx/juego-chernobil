...
const Pregunta23 = ()=>{
    ...
    <h1 class=" w-1/3 relative ml-10 bottom-10 left-1/3 text-center font-Ubuntu text-white text-2xl ">23 ¿en la actualidad hay  animales  en la zona de exclucion?</h1>

    <img src={cherimagenes(`./cher-23.png`)} class="relative ml-96 left-52" />
        <ul class="flex flex-col relative ml-80 left-1/4 top-10  w-2 pregunta1 ">
       <Link to="/Video23" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Solo hay perros y gatos</Link>
       <Link to="/Pregunta24" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Solo hay vida Silvestre</Link>
       <Link to="/Video23" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >No hay vida</Link>
       <Link to="/Video23" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Solo hay vegetacion</Link>
       </ul>

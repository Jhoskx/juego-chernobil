...
<img src={cherimagenes(`./logoucc.png`)} class="relative left-4" />
    ...
    <h1 class=" w-1/3 relative ml-10 bottom-10 left-1/3 text-center font-Ubuntu text-white text-2xl ">6  ¿Cuántos empleados estaban trabajando en el bloque 4?</h1>

    <img src={cherimagenes(`./cher-6.jpg`)} class="relative ml-96 left-8" />
        <ul class="flex flex-col relative ml-80 left-1/4 top-10  w-2 pregunta1 ">
       <Link to="/Pregunta7" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >176 Empleados</Link>
       <Link to="/Video6" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >200 Empleados</Link>
       <Link to="/Video6" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >210 Empleados</Link>
       <Link to="/Video6" class=" my-2 w-80 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >215 Empleados</Link>
       </ul>

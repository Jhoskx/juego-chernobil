...
const Video13 = ()=>{
    ...
    <ReactPlayer   url='https://www.youtube.com/watch?v=tJqRfIszawU&ab_channel=jhonatan_611'
    controls
    width='70%'
    height='70%'    
    />
    ...
    <Link to="/Pregunta14" class=" w-2 h-10 my-40 text-center text-white font-Ubuntu border-2 border-white rounded-lg " >Siguiente Pregunta</Link>
    </div>
</div>
}
